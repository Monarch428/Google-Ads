    ...
    features: [
      {
        ...
        description: "Core vitals, funnel coverage, and visitor journey highlights.",
...
export const MODULE_VIEW_ROUTES: Record<ModuleId, Record<string, string>> = {
  ...
  seo: {
    ...
    "keyword-research": "/modules/seo/keywords",
    "content-briefs": "/modules/seo/content-briefs",
    "rank-monitoring": "/modules/seo/rank-monitoring",
  },
  website: {
